...
class Arc2Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Rect rect2 = Rect.fromLTWH(
        0.0 + (0.2 * size.width) / 2, 0.0 + (0.2 * size.height) / 2, size.width - 0.2 * size.width, size.height - 0.2 * size.height);
...
class Arc3Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Rect rect3 = Rect.fromLTWH(
        0.0 + (0.4 * size.width) / 2, 0.0 + (0.4 * size.height) / 2, size.width - 0.4 * size.width, size.height - 0.4 * size.height);
